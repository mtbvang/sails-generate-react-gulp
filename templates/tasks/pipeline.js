 ...
 * 
 * (Note that you can take advantage of gulp-style wildcard/glob/splat
 * expressions for matching multiple files.)
 */
...
// var appRootDir = browserifyMainFile.substring(0,
// browserifyMainFile.lastIndexOf('/'));
// This is the path which tyhe bablify task will look to for transcompiling
// ES6->ES5
...
// var packagesToInstall = ['gulp-shell', 'gulp-react', 'gulp-browserify',
// 'gulp-babel', 'react-bootstrap', 'react', 'babel'];
